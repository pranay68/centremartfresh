...
import { FaHome, FaShoppingCart, FaRegCommentDots, FaBell, FaUser } from 'react-icons/fa';
...
const BottomNav = () => {
  ...
  return (
    <nav className="bottom-nav">
      ...
      <button className="nav-btn" onClick={() => navigate('/messages')}> <FaRegCommentDots /> <span>Message</span> </button>
