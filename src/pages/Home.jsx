...
const Home = () => {
  ...
  return (
    <div className="home-page">
      ...
      {/* Popular Section - horizontal scroll on mobile */}
      <section className="popular-section mobile-horizontal-scroll">
        <h2 className="section-title">Popular</h2>
        <div className="product-row">
          {allProducts.slice(0, 5).map(product => (
            <ProductCard key={product.id} product={product} onProductClick={handleProductClick} compact={true} />
          ))}
        </div>
      </section>
      {/* Promotions Section - horizontal scroll on mobile */}
      <section className="promotions-section mobile-horizontal-scroll">
      ...
      {/* Recently Viewed Section - horizontal scroll on mobile */}
      {recentlyViewed.length > 0 && (
        <section className="recently-viewed-section mobile-horizontal-scroll">
